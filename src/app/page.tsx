...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="w-full max-w-5xl m-auto relative">
        <textarea
          ...
          cols={30}
          rows={15} />
        <Copy size={30} onClick={handleCopyTextToClipboard} className="absolute bottom-12 right-6 cursor-pointer hover:text-[#0297ee] rounded transition-all" />
